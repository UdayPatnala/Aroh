      ...
      <header className="sticky top-0 bg-[#0a0a0c]/80 backdrop-blur-md border-b border-white/10 px-6 py-4 relative z-50">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div
            ...
            className="hidden md:flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/5 border border-white/10 hover:border-amber-500/50 cursor-pointer text-zinc-400 transition-colors text-xs w-64 max-w-xs mx-auto focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
            tabIndex={0}
